...
if( !$edicao ) {
    ...
    $query = $GLOBALS['pdo']->prepare("INSERT INTO contatos(id_usuario, nome, email, celular) VALUES(:id_usuario, :nome, :email, :celular)");
...
if( $edicao ) {
    ...
    // Monta a Query
    $query = $GLOBALS['pdo']->prepare("UPDATE contatos SET nome=:nome, email=:email, celular=:celular WHERE id_usuario=:id_usuario AND id=:id");
