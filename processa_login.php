...
// Monta a Query
$query = $GLOBALS['pdo']->prepare("SELECT id, nome, email FROM usuarios WHERE email=:email AND senha=:email");
//$query = $GLOBALS['pdo']->prepare("SELECT id, nome, email FROM usuarios WHERE email=:email");
